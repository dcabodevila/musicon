...
public enum EmailTemplateEnum {
    ...
    VALIDAR_USUARIO("Nuevo usuario registrado en Gestmusica", "Gestmusica","Nuevo usuario", "Se ha registrado un nuevo usuario, entre en la sección de Usuarios para validarlo.","base-email");
