...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
	...
	@Query("select new es.musicalia.gestmusica.usuario.UsuarioAdminListRecord(u.id, u.nombre,u.apellidos, u.email, u.fechaUltimoAcceso, u.activo, u.validado) from Usuario u order by u.nombre || ' ' || u.apellidos")
